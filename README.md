...
1.	강의를 틀고, 모르면 멈추고, AI에게 묻는다
MIT 선형대수 강의를 듣다가 고유값 분해가 나오면 멈춥니다.
AI에게 묻습니다.
“고유값 분해가 왜 중요한가? 금융 데이터 분석에서 이것이 어디에 쓰이는가?”
교수님은 200명에게 같은 설명을 하지만,
AI는 질문한 사람의 맥락에 맞춰 설명합니다.
유학의 장점 중 하나가 “모르는 것을 바로 물어볼 수 있는 환경”인데,
그 부분만큼은 AI가 상당 부분 대체하고 있습니다.
	
2.	1시간 강의를 5분 복습 노트로 변환한다
MIT OCW는 많은 강의에 트랜스크립트를 제공합니다.
유튜브 강의도 자막 추출이 가능합니다.
AI에 넣고 “핵심 개념 5개, 한 줄 요약”을 요청하면
1시간 강의가 5분짜리 핵심 정리가 됩니다.
단, 수학 강의는 칠판 위의 수식이 핵심입니다.
영상 시청이 메인이고, AI 요약은 복습 보조입니다.
이 순서를 바꾸면 공부가 아니라 자기위안이 됩니다.

3.	AI에게 문제를 출제시켜 자기 검증을 한다
강의 하나를 끝내고 AI에게 시킵니다.
“이 내용으로 중상 난이도 문제 3개를 내줘.”
틀리면 어디서 틀렸는지 바로 짚어줍니다.
주의할 점이 있습니다.
AI가 출제한 문제의 모범답안이 가끔 틀립니다.
특히 증명 문제에서 그렇습니다.
AI를 활용하되, 교재와 교차 검증하는 습관이 필요합니다.
